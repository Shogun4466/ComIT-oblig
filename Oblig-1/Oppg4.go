//package ascii(eller iso) og funksjonsnavn "iterateOverExtendedASCIIStringLiteral" fungerer ikke enn så lenge. Bruker main.
...
func main() {
	const sample = "\x80\x81\x82\x83\x84\x85\x86\x87\x88\x89\x8A\x8B\x8C\x8D\x8E\x8F\x90\x91\x92" +
